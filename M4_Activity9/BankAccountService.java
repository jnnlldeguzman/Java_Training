...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (accountNumber == null || accountNumber.trim().isEmpty()) {
			...
			throw new InvalidAccountException("Account number cannot be null oe Empty");
		}
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			throw new InvalidAccountException("Minimum initial balance: " + String.format("%.2f", MINIMUM_INITIAL_BALANCE) + 
					"Received: " + String.format("%.2f",initialBalance));
