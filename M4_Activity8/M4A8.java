...
class BankAccount4 {
    private static final Logger logger = LoggerFactory.getLogger(BankAccount4.class);
...
public class M4A8 {
	...
	private static final Logger logger = LoggerFactory.getLogger(M4A8.class);
